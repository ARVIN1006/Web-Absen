...
<div class="admin-wrap">
    <div class="admin-header">
        ...
        <button onclick="openAddModal()" class="btn-primary">+ Tambah Jabatan</button>
    </div>
        ...
        <div class="table-resp">
            <table class="table">
                ...
                <tbody>
                    ...
                    <tr>
                        <td><b>{{ $pos->name }}</b></td>
                        <td>{{ $pos->users_count }} Orang</td>
                        <td>
                            <div style="display:flex; gap:8px;">
                                <button type="button" class="btn-action btn-edit" onclick="openEditModal({{ $pos }})">Edit</button>
                                <form action="{{ route('admin.positions.destroy', $pos->id) }}" method="POST" onsubmit="return confirm('Yakin ingin menghapus jabatan ini?');">
                                    @csrf @method('DELETE')
                    ...
                    <tr>
                        <td colspan="3" style="text-align: center; color: var(--text-muted); padding: 20px;">Belum ada data jabatan.</td>
                    </tr>
                    @endif
                </tbody>
            </table>
        ...
        <div class="modal-body">
            <form action="{{ route('admin.positions.store') }}" method="POST">
                ...
                <div class="form-group">
                    ...
                    <input type="text" name="name" class="form-control" required placeholder="Mis. Staff IT, Manager, dsb.">
                </div>
                <button type="submit" class="btn-primary" style="width:100%; justify-content:center;">Simpan Jabatan</button>
            </form>
        </div>
    </div>
</div>
    ...
    <div class="modal">
        ...
        <div class="modal-body">
            <form id="editForm" method="POST">
                ...
                <button type="submit" class="btn-primary" style="width:100%; justify-content:center;">Update Jabatan</button>
            </form>
        </div>
    </div>
</div>
